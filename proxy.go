...
// ProxyConfig 配置 headroom HTTP 代理。
...
func NewProxy(cfg ProxyConfig) http.Handler {
	...
	mux.HandleFunc("/v1/chat/completions", func(w http.ResponseWriter, r *http.Request) {
		...
		// 压缩 messages
		compressed, err := Compress(msgs, cfg.CompressOptions)
		if err != nil {
			w.Header().Set("Content-Type", "application/json")
...
func forwardToUpstream(w http.ResponseWriter, r *http.Request, cfg ProxyConfig, body []byte) {
